...
prev_reward = 0
prev_action = 0
global_offload_dropped = 0
global_local_dropped = 0

timestep_iter = 10000

while time_step < timestep_iter:
...
global_nn_loss = agent.trainer.loss
print(global_nn_loss)
plot(
    global_reward_sum,
    global_running,
    global_energy_running,
...
print("Offload dropped : ",global_offload_dropped)
print("Local Dropped : ",global_local_dropped)
# Calculate drop rate
